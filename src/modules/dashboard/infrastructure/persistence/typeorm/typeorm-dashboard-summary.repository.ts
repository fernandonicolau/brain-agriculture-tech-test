...
@Injectable()
export class TypeOrmDashboardSummaryRepository implements DashboardSummaryRepositoryPort {
  constructor(
  ...
  private async getTotals(): Promise<DashboardSummaryResult['totals']> {
  ...
  private async getByState(): Promise<DashboardSummaryResult['byState']> {
  ...
  private async getByCrop(): Promise<DashboardSummaryResult['byCrop']> {
  ...
  private async getLandUse(): Promise<DashboardSummaryResult['landUse']> {
